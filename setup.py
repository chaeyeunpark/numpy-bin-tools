...
with open("numpy_bin_tools/_version.py") as f:
...
info = {
    ...
    "url": "https://github.com/chaeyeunpark/numpy-bin-tools",
    "license": "GNU Lesser General Public License v2.1",
    "packages": find_packages(where="."),
    "package_data": {},
    "entry_points": {
    },
    "description": "C++ implemenation of fast some helper functions with a python binding",
    "long_description": open("README.rst").read(),
    "long_description_content_type": "text/x-rst",
    "provides": ["numpy_bin_tools"],
    "install_requires": requirements,
    "ext_modules": [CMakeExtension("_numpy_bin_tools")],
    "cmdclass": {"build_ext": CMakeBuild},
    "ext_package": "numpy_bin_tools"
}
